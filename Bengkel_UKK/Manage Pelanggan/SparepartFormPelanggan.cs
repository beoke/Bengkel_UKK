...
{
    public partial class SparepartFormPelanggan : Form
    {
        ...
        {
            DhafaPanel1.Resize += (s, e) => DhafaPanel1.Invalidate();
        ...
        {
            // Ukuran asli panel
            int originalWidth = DhafaPanel1.Width;
            int originalHeight = DhafaPanel1.Height;
            ...
            using (Bitmap originalBitmap = new Bitmap(originalWidth, originalHeight))
            {
                using (Graphics g = Graphics.FromImage(originalBitmap))
                {
                    ...
                    g.CopyFromScreen(DhafaPanel1.PointToScreen(Point.Empty), Point.Empty, new Size(originalWidth, originalHeight));
                }
